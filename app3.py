...
def main():
    ...
    while z:
        ...
        <h2 style="color:white;text-align:center;">movie le lo using streamlit </h2>
        </div>
        """
        st.markdown(html_temp,unsafe_allow_html=True)    
        m = st.text_input("Enter the name and year of the movie","Type here")
        try:
            pass    
            ...
            if st.button("No"):
                st.text("Thank you using our software")
                z=False
                break
            else:
                z=True
